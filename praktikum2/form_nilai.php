...
<body>
    <div class="container">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
            <input id="nama" name="nama" placeholder="Masukan Nama Lengkap" type="text" class="form-control" aria-describedby="namaHelpBlock" required="required"> 
            <span id="namaHelpBlock" class="form-text text-muted"></span>
            </div>
        </div>
        <div class="form-group row">
            <label for="Matakul" class="col-4 col-form-label">Mata Kuliah</label> 
            <div class="col-8">
            <select id="Matakul" name="Matakul" class="custom-select" required="required">
